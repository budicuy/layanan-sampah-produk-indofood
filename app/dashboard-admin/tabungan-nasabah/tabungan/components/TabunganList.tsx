...
type NasabahWithTabungan = Prisma.NasabahGetPayload<{
  include: {
    setorSampah: {
      include: {
...
type SetorSampah = NasabahWithTabungan["setorSampah"][number];
type MutasiSaldo = NasabahWithTabungan["mutasiSaldo"][number];
...
export default function TabunganList({
  nasabahs,
}: {
  nasabahs: NasabahWithTabungan[];
}) {
